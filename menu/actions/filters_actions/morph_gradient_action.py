...
class MorphGradientAction(BaseAction):
    def __init__(self, parent):
        super().__init__(parent, 'Gradient', self.init_command)

    def init_command(self):
        return InitMorphologyCommand(
            **{MenuCommandsConstants.MORPHOLOGY_COMMAND_PAYLOAD.name: MorphologicalConstants.MORPH_GRADIENT.name}
        )
