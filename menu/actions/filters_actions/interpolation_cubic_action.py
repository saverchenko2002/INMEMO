...
class InterpolationCubicAction(BaseAction):
    def __init__(self, parent):
        super().__init__(parent, 'Cubic', self.init_command)

    def init_command(self):
        return InitInterpolationCommand(
            **{MenuCommandsConstants.INTERPOLATION_COMMAND_PAYLOAD.name: InterpolationConstants.INTER_CUBIC.name}
        )
